...
- **`docs/CONTEXT.md`** — this repo keeps the glossary under `docs/`, not the repo root.
...
Single-context repo; domain docs live under `docs/`:
...
> _Contradicts ADR-0001 (tech stack) — but worth reopening because…_
