...
| KR 负责人 | 与我相关的卡点（本人 KR 下有卡点、互锁待行动人）；裁决 11 后无终审职责 |
| 中间审核人 | 待我审批（中间审核或签） |
...
| 完成审批中 | 已提交完成申请，处于中间审核或终审 | 提交完成申请 | 等待他人（显示当前环节） |
...
| 待终审 | 完成审批中（环节：终审） | 待终审 | 项目管理员集合（或签，裁决 11） |
| 已退回 | 进行中 | 已退回 | 任务负责人 |
...
| 职责 | 决定的动作 |
|---|---|
| KR 负责人 | 接收本人 KR 下任务入池与字段修改通知（裁决 #162／#172）；裁决 10／11 后无审批职责 |
...
| MW-08 | 终审（裁决 11 改写） | 终审件在每位项目管理员（含项目负责人）的待我审批，任一人处理后其余待办关闭；打开后进入“审核”Tab并高亮本次交付物与或签链；KR 负责人与普通成员看不到该件 |
