...
var passwordChangeRequiredAllowlist = []string{"/auth/login", "/auth/logout", "/auth/change-password", "/auth/me", "/healthz", "/branding", "/branding/logo", "/auth/password-reset/request", "/auth/password-reset/confirm"}
